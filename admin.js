document.addEventListener('DOMContentLoaded', () => {
    ...
    const weeklyTrendsData = {
        labels: ['Jul Week 4', 'Aug Week 1', 'Aug Week 2', 'Aug Week 3', 'Aug Week 4', 'Sep Week 1'],
    ...
    // Chart 1: Overall Wellness Trends (Line Chart)
            ...
            datasets: [
                {
                    ...
                    data: weeklyTrendsData.phqScores,
                ...
                },
                {
                    ...
                    data: weeklyTrendsData.gadScores,
    ...
    // Chart 2: Key Concern Areas (Doughnut Chart)
    ...
    // Chart 3: Resource Engagement (Bar Chart)
